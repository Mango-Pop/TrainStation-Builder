...
function Footer({
  companyName = "Train Station Fitness Center",
  companyDescription = "Transforming lives through fitness since 2010",
  logoSvg
}: FooterProps) {
  ...
  return (
    <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
      <aside>
        <div dangerouslySetInnerHTML={{ __html: logoSvg || defaultLogoSvg }} />
        <p>
          {companyName}
          <br />
          {companyDescription}
