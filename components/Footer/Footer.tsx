...
function Footer() {
  ...
  return (
    footerData !== null && (
      <footer className="flex flex-col md:flex-row items-center md:items-start flex-wrap bg-black text-base-content p-10 gap-8 md:gap-5">
        <div className="w-auto md:w-full">
          ...
          >
            <style type="text/css">
              {`.st0{fill:#fff;} @media (prefers-color-scheme: dark) { .st0{fill:#fff;} }`}
            </style>
            <g>
              <defs>
        ...
        <div className="flex flex-col items-center gap-2 md:items-start grow max-w-full md:max-w-1/3">
          <h6 className="text-inter font-bold">Location</h6>
          <p className="text-inter font-light text-sm text-center md:text-start">{footerData.location}</p>
        </div>
        <div className="flex flex-col items-center gap-2 md:items-start grow max-w-full md:max-w-1/3">
          <h6 className="text-inter font-bold">Contact</h6>
          <p className="text-inter font-light text-sm">{footerData.email}</p>
          <p className="text-inter font-light text-sm">{footerData.phone}</p>
          <div className="flex gap-1">
            {footerData.socialMedia.map((socialData, index) => (
              <Link key={socialData.socialMediaType + index} href={socialData.socialMediaUrl}>
                {socialData.socialMediaType === 'facebook' && (
                ...
                {socialData.socialMediaType === 'instagram' && (
                  <svg className="w-6 h-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                ...
                {socialData.socialMediaType === 'tiktok' && (
                  <svg className="w-6 h-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        ...
        <nav className="flex flex-col items-center gap-2 md:items-start grow max-w-full md:max-w-1/3">
          <h6 className="text-inter font-bold">Staffed Hours</h6>
          {footerData.hoursOfOperation.map((hoursData, index) => (
            <div key={`staffedHours-${index}`}>
              <p className="link link-hover text-inter text-center md:text-start font-bold text-sm">{hoursData.dayText}</p>
              <p className="link link-hover text-inter text-center md:text-start font-light text-sm">{hoursData.hoursText}</p>
            </div>
          ))}
        </nav>
        <div className="w-full flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-5">
          <Link className="link link-hover text-inter font-light text-sm" href="#">Terms of Use</Link>
          <Link className="link link-hover text-inter font-light text-sm" href="#">Privacy Policy</Link>
          <Link className="link link-hover text-inter font-light text-sm" href="#">Liability Waver</Link>
        </div>
        <p className="w-full text-center text-inter font-light text-sm">©Train Station {currentYear}</p>
      </footer>
    )
  );
}
